...
TCL_DEFS='-nologo -c -W3 -DUNICODE -D_UNICODE -D_USING_V110_SDK71_ -D_ATL_XP_TARGETING  -W3 -D _CRT_SECURE_NO_DEPRECATE -D _CRT_NONSTDC_NO_DEPRECATE -Fp.\Release_AMD64_VC13\tcl_ThreadedDynamic\ -O2  -Ot -Oi -fp:strict -Gs -GS -GL -Zi -MT -I"C:\dev\Tcl\core\trunk\tcl\win\..\win" -I"C:\dev\Tcl\core\trunk\tcl\win\..\generic" -I"C:\dev\Tcl\core\trunk\tcl\win\..\libtommath" -DTCL_TOMMATH -DMP_PREC=4 -Dinline=__inline -DHAVE_ZLIB=1 -DTCL_CFGVAL_ENCODING=\"cp1252\" -DSTDC_HEADERS -DTCL_THREADS=1 -DUSE_THREAD_ALLOC=1 -DNDEBUG -DTCL_CFG_OPTIMIZED -DTCL_CFG_DO64BIT'
...
TCL_SHLIB_LD='link -nologo -machine:AMD64 -ltcg -release -opt:ref -opt:icf,3 -debug -debugtype:cv -dll'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='T:\Tcl\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IT:\Tcl\include'
...
# compiled.
TCL_SRC_DIR='C:\dev\Tcl\core\trunk\tcl\win\..'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LT:\Tcl\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='.\Release_AMD64_VC13\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='T:\Tcl\lib\tclstub86.lib'
